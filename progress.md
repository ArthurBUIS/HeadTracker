...
| `src/core/simple/simpleFaceEngine.ts` | **Simple pipeline.** Face detector → proximity tracker → per-face **300×200** captureStream, glided 3:2 crop. | `SimpleFaceEngine`, `FaceCenterDetector`, `SimpleFaceCallbacks` |
